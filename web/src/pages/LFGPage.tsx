...
export default function LFGPage()
{
  ...
  return (
    <div className="relative flex min-h-0 flex-1 overflow-hidden text-slate-100">
      <div className="mx-auto flex h-full min-h-0 w-full max-w-5xl flex-1 flex-col overflow-hidden px-6 py-6">
        ...
        <div className="mt-6 grid min-h-0 flex-1 grid-cols-1 gap-4 overflow-hidden lg:grid-cols-[minmax(0,1fr)_340px]">
          <LFGGamesPanel
            games={games}
